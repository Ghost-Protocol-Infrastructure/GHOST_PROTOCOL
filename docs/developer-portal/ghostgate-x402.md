...
- The documentation, metadata contract, and SDK guidance slice of Phase A is complete here; the public demo target remains a separate implementation step.
...
```bash
curl -sS "https://ghostprotocol.cc/api/pricing?service=agent-2212"
```
