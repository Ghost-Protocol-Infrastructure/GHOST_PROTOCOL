...
const GHOSTWIRE_DOC_URL =
  "https://github.com/Ghost-Protocol-Infrastructure/GHOST_PROTOCOL/blob/main/docs/developer-portal/ghostwire.md";
          ...
          <div className="col-span-1 lg:col-span-5 grid grid-rows-3">
            ...
            >
              ...
              <p className="text-neutral-500 text-sm mb-6">
                The Trust Layer. A decentralized leaderboard indexing performance, uptime, and yield. The Reputation Registry for Autonomous Agents.
              </p>
